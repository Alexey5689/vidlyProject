                    ...
                    <div className="col colorFoot">
                        <div className="container " >  
                            <div className="row align-items-center  pt-3 pb-3" >
                                ...
                                <div className="col-xl-3 col-md-6 col-md-6 col-sm-7 col-lg-4 col-xl-3 col-xxl-4 font d-flex justify-content-start justify-content-center">Вдохновение за мгновение<span style={{color:'black'}}>...</span></div>
                                <div className="col-sm-12 col-md-12 col-lg-5 col-xl-6 pr-5 mt-sm-3 mt-md-3 mt-lg-0  d-flex justify-content-sm-center justify-content-md-center justify-content-lg-end justify-content-center">
